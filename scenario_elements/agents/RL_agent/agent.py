...
class RLVehiclesConfig(BaseModel):
    
    vehicles: List[WaypointVehicleConfig] = Field(..., description="List of vehicle configurations")
    

class RLVehiclesAgent(AgentBase):
    ...
    def __init__(
        ...
        super(RLVehiclesAgent, self).__init__(
            id=id,
            sim_ctn_name=sim_ctn_name,
            actor_config=actor_config,
            other_config=other_config,
        ...
        # 2. use model to control waypoint vehicles.
