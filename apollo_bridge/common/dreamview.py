...
class Dreamview:
    ...
    def __init__(self, ip: str, port: int) -> None:
        ...
        # logger.debug(f'Dreamview connects to {self.url}')
    ...
    def set_hd_map(self, hd_map):
        ...
        if not self.get_current_map() == mapped_map:
            ...
            raise RuntimeError(error_message.format(mapped_map, folder_name))
        # logger.debug(f'Set HD_MAP {hd_map} from Dreamview')
        return
    ...
    def set_vehicle(self, vehicle):
        ...
        if not self.get_current_vehicle() == mapped_vehicle:
            ...
            raise RuntimeError(error_message.format(mapped_vehicle, folder_name))
            # sys.exit(1)
